...
public class MenuPrincipal {
	...
	public static void mostrarMenu() {
		...
		do {
			...
			Mensajes.imprimirCentrado("****** MENÚ PRINCIPAL ******", ColorTexto.NEGRO_CYAN); ColorTexto.colorTexto(""
							+ "\n1 . Venta de entradas\n"
							+ "2 . Resumen de ventas\n"
							+ "3 . Ingresos totales\n"
			...
			switch (opcionMenu) {
			case 1:	VentaEntradas.ubicacion(); break;
			case 2:	if (hayVentasRegistradas()) { ResumenDeVentas.resumen(); } break;
			case 3:	if (hayVentasRegistradas()) { IngresosTotales.ingresosTotales(); } break;
			case 9:	Mensajes.mensajeFinal(); break;
			default: Decorativo.separadorSegmentadoCyan();
					 System.out.println("\n\n\n");
